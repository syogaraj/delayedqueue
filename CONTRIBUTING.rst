...
Welcome to ``delayedqueue`` contributor's guide.
...
If you experience bugs or general issues with ``delayedqueue``, please have a look
...
You can help improve ``delayedqueue`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``delayedqueue`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``delayedqueue``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n delayedqueue python=3 six virtualenv pytest pytest-cov
    conda activate delayedqueue
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/delayedqueue.git
    cd delayedqueue
...
#. Install |pre-commit|_::
   ...
   ``delayedqueue`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/delayedqueue
.. _issue tracker: https://github.com/<USERNAME>/delayedqueue/issues
.. <-- end -->
